...
protected:
	...
	void Input_ConfirmTargeting(const FInputActionValue& InputActionValue);
	void Input_CancelTargeting(const FInputActionValue& InputActionValue);
...
private:
	TObjectPtr<ULockOnTargetComponent> LockOnTarget;
