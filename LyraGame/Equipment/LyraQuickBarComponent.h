...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly)
	ULyraInventoryItemInstance* AddItemFromInventory(ULyraInventoryItemInstance* ItemToAdd);

	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly)
	void HolsterWeapon();

	UFUNCTION(BlueprintCallable)
	ULyraEquipmentInstance* GetEquippedItem() { return EquippedItem ? EquippedItem : nullptr; }
