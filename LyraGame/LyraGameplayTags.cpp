...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Confirm, "InputTag.Confirm", "Confirm ability targeting input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Cancel, "InputTag.Cancel", "Cancel ability targeting input.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Cheat_UnlimitedMana, "Cheat.UnlimitedMana", "UnlimitedMana cheat is active on the owner.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Movement_Mode_Climbing, "Movement.Mode.Climbing", "Default Character movement tag");
	...
	const TMap<uint8, FGameplayTag> CustomMovementModeTagMap =
	{
		...
		{MOVE_Climbing, Movement_Mode_Climbing}
	};
